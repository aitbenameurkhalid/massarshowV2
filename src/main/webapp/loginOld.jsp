...
<%--&lt;%&ndash;                <input type="text" id="usernameId" name="username" placeholder="<%= loginUserName %>" autofocus="autofocus">&ndash;%&gt;--%>
<%--              </div>--%>
<%--              <div class="input-prepend">--%>
<%--                <span class="add-on"><i class="fa fa-lock"></i></span>--%>
<%--&lt;%&ndash;                <input type="password" id="passwordId" name="password" placeholder="<%= loginPassword %>">&ndash;%&gt;--%>
<%--              </div>--%>
