...
import com.hakibati.eau.electricite.db.ConsommationElectricite;
import com.hakibati.eau.electricite.db.GestionEauElectricite;
import com.hakibati.eau.electricite.db.repo.ConsommationElectriciteRepository;
...
public class ConsommationElectriciteService {
  ...
  public File getFileListConsommationElectricite(String dateDu, String dateFin) throws IOException {
    ...
    cell.setCellValue(I18n.get("Contrat Electricite"));
    cell.setCellStyle(cellStyle);
    ...
    for (EtablissementLiaison etablissementLiaison :
      ...
      ConsommationElectricite consommationElectricite =
          consommationElectriciteRepository
              ...
              .fetchOne();
      if (consommationElectricite != null) {
        cell = rowHead.createCell(5);
        cell.setCellValue(consommationElectricite.getDateDu().toString());
        cell.setCellStyle(cellStyleBody);
        cell = rowHead.createCell(6);
        cell.setCellValue(consommationElectricite.getCompteurDu());
        cell.setCellStyle(cellStyleBody);
        cell = rowHead.createCell(7);
        cell.setCellValue(consommationElectricite.getDateFin().toString());
        cell.setCellStyle(cellStyleBody);
        cell = rowHead.createCell(8);
        cell.setCellValue(consommationElectricite.getCompteurFin());
        cell.setCellStyle(cellStyleBody);
        cell = rowHead.createCell(9);
        cell.setCellValue(consommationElectricite.getQuantiteConsommation());
        cell.setCellStyle(cellStyleBody);
        cell = rowHead.createCell(10);
        cell.setCellValue(consommationElectricite.getMontantConsommation());
        cell.setCellStyle(cellStyleBody);
      } else {
        cell = rowHead.createCell(5);
  ...
  public void initialize() throws IOException {
    excelFile = File.createTempFile("Consommation_eau", ".xlsx");
